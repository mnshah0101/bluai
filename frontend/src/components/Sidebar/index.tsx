      ...
      <div className="flex items-center justify-between gap-2 px-7 py-5.5 lg:py-6.5">
        <Link href="/">
          <Image
            width={100}
            height={32}
            src={"/logos/blue_logo_white_text.png"}
            alt="Logo"
            priority
          />
        </Link>
    ...
    >
      {project.title}
              ...
              <li>
                <Link
                  href="/createProject"
                  className={`btn btn-primary group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
