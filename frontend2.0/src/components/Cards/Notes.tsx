...
function Notes() {
    ...
    const {loading, user} = useUser() as {loading: boolean, user: User | null}
    ...
    async function getSuggestions(){
        if(loading == false && user) {
            let response = await fetch(process.env.NEXT_PUBLIC_SERVER_URL+ '/api/projects/userSuggestions/' + user.userId)
