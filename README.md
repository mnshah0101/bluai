...
Blu uses NextJS build on the frontend and Express.js as the server in the backend. This will direct you on how to start your deployment.
...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/mnshah0101/bluai.git
   ```
...
The usage is pretty simple. Sign in. Create a new project. Get your suggestions from your codebase. Use your project key to track your AI's enviornmental impact.
...
- [x] Fine Tune LLM for suggestions
...
Your Name - [@your_twitter](https://twitter.com/mokshie33) - mnshah0101

Project Link: [https://github.com/mnshah0101/bluai](https://github.com/mnshah0101/bluai)
